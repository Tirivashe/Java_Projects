...
public class ArrayLists {
    static final String CURRENT_FOLDER_PATH = "C:\\Users\\Tirivashe\\IdeaProjects\\ArrayLists\\src\\";
    ...
    private static void writeToOutputFile (String outFileName, ArrayList<FacultyMember> facMembers){
        createFile facList = new createFile();
        facList.openFile(outFileName);
        facList.addRecords(facMembers);
        facList.close();
    }
    ...
    public static void main (String[] args) throws IOException {
        ...
        if(inputFileExists == 1){
            ...
            writeToOutputFile(inFileName,facMembers);
            ...
            writeToOutputFile(outFileName,facMembers);
        }
    }
