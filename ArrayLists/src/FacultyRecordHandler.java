...
public class FacultyRecordHandler {
    ...
    private static void writeToOutputFile (Path outFilePath, ArrayList<FacultyMember> facMembers){
    ...
    public static void main (String[] args) throws IOException {
        ...
        if(inputFileExists == 1){
            ...
            writeToOutputFile(Paths.get(inFileName),facMembers);
            ...
            writeToOutputFile(Paths.get(CURRENT_FOLDER_PATH + outFileName),facMembers);
        }
    }
}
